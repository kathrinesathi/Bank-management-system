...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
		...
		$ins_sql = "INSERT INTO accounts (accno, customerid, accstatus, accopendate, accountbalance) VALUES 
					('".$accno."', '".$customerid."', '".$accstatus."', '".$accdate."', '".$accbalance."')";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="accno" class="form-control"
                                                    placeholder="Enter account number" id="accno" required>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
					<label for="number" class="col-sm-3 control-label">Account number *</label>
						<div class="col-sm-8">
							<input type="text" name="accno" class="form-control" placeholder="Enter account number" id="accno" required>
                                        ...
                                        <div class="form-group">
                                            <label for="number" class="col-sm-3 control-label">Account Status *</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="accountbalance" class="form-control"
                                                    placeholder="Enter Amount" id="accountbalance" required>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
							...
							<select class="form-control" name="accounttype" id="accounttype">
								...
								<option>Current</option>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="accountbalance" class="form-control"
                                                    placeholder="Enter the balance" id="accountbalance" required>
                                            </div>
                                        </div> -->
                                        <div class="form-group">
