                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Grant Loan</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <section class="col-lg-8">
                                ...
                                <form class="form-horizontal" action="grantloan.php" method="post" role="form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="accno" class="form-control"
                                                placeholder="Enter account no" id="accno" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="ltype" class="form-control"
                                                placeholder="Enter the loan type" id="ltype" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="number" class="col-sm-3 control-label">Loan amount *</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="lamount" class="form-control"
                                                placeholder="Enter the amount" id="lamount" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="linterest" class="form-control"
                                                placeholder="Enter interest percentage" id="linterest" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
