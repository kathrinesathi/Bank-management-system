...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
			...
			$sql1 = "SELECT * FROM accounts WHERE customerid = $id";
			$run1 = mysqli_query($con, $sql1);

			$rows = mysqli_fetch_array($run1);

			$accno = $rows['accno'];
			$owner_balance = $rows['accountbalance'];
			...
			if($amount>0){
				...
				if($temp>0){
					...
					$loan_rem = $rows['loanamount'];
					$loan = $loan_rem - $amount;

					$sql5 = "UPDATE loan SET loanamount = $loan WHERE loantype = '$loantype' AND accno = '$accno'";
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Loan payment</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="loantype" class="form-control"
                                                placeholder="Enter loantype" id="loantype" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="paidamount" class="form-control"
                                                placeholder="Enter the amount" id="paidamount" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
