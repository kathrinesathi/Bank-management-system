...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
			...
			if($temp>0){
				...
				$ins_sql = "INSERT INTO registered_payee (ownerno, payeename, accno, accounttype, iban) VALUES ('".$owner_no."','".$accname."', '".$accno."', '".$acctype."', '".$accifsc."')";
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Register payee</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <section class="col-lg-8">
                                ...
                                <form class="form-horizontal" action="payee.php" method="post" role="form">
                                    <div class="form-group">
                                        <b><label for="name" class="col-sm-3 control-label">Full Name *</label>
                                        <div class="col-sm-8">
                                            <input type="text" name="accname" class="form-control"
                                                placeholder="Enter your name" id="accname" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="iban" class="form-control"
                                                placeholder="Enter IBAN Code" id="iban" required></b>
                                        </div>
                                    </div>
                                    <div class="form-group">
