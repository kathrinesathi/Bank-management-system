...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
			...
			$sql1 = "DELETE FROM registered_payee WHERE accno = '$payee_no'";
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Remove payee</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <section class="col-lg-8">
                                ...
                                <form class="form-horizontal" action="removepayee.php" method="post" role="form">
                                    <div class="form-group">
                                        <b><label for="name" class="col-sm-3 control-label">Payee Name *</label>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="accno" class="form-control"
                                                placeholder="Enter account number" id="accnumber" required></b>
                                        </div>
                                    </div>
                                    <div class="form-group">
