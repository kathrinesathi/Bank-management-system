...
include 'includes/dbconnect.php';
	...
	if(isset($_POST['submit'])){
		...
		if(isset($_POST['submit'])){
            ...
            $ins_sql = "INSERT INTO employees (empid, contactno, empname, emailid, password, createdat, last_login) VALUES ('".$empid."', '".$contactno."', '".$empname."','".$emailid."', '".$password."','".$accdate."','".$lastlogin."' )";
                        ...
                        <article class="row">
                            <section class="col-sm-8">
                                ...
                                <form class="form-horizontal" action="signup.php" method="post" role="form">
                                    <b>
                                        <div class="form-group">
                                            <label for="number" class="col-sm-3 control-label">Employee ID :</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="empid" class="form-control"
                                                    placeholder="Enter Employee id" id="empid" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="number" class="col-sm-3 control-label">Employee Name :</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="empname" class="form-control"
                                                    placeholder="Enter Employee's first name" id="empname" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="number" class="col-sm-3 control-label">Contact Number :</label>
                                            <div class="col-sm-8">
                                                <input type="text" name="contactno" class="form-control"
                                                    placeholder="Enter contact number" id="contactno" required>
                                            </div>
                                        </div>
